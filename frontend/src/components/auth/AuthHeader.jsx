...
export default function AuthHeader({ theme, setTheme, showToast }) {
  return (
    <>
        ...
        <button
          onClick={() => {
            ...
            console.log(
              "Ancien thème:",
              theme,
              "-> Nouveau thème demandé:",
              newTheme,
            );

            // 1. On change le thème en premier
            setTheme(newTheme);

            // 2. On appelle le toast de manière sécurisée (si la fonction existe)
          ...
          className="p-2.5 rounded-xl border border-slate-200/80 dark:border-slate-800 bg-white/60 dark:bg-slate-900/60 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 cursor-pointer"
